...
url = "https://api.github.com/repos/1407arjun/CI-Issue-Forms/issues/" + str(issue_number)
...
# for i in range(1, monthrange(year, month_num)[1] + 1):
#     dirs = os.listdir(path)
#     if ("day-" + str(i)) in dirs and len(os.listdir(os.path.join(path, "day-" + str(i)))) > 1:
#         cpp = getBadges(os.path.join(path, "day-" + str(i)), "C++", ".cpp", "cplusplus", str(i), "blue")
#         java = getBadges(os.path.join(path, "day-" + str(i)), "Java", ".java", "java", str(i), "red")
#         py = getBadges(os.path.join(path, "day-" + str(i)), "Python", ".py", "python", str(i), "yellow")
#         month_readme.write("\n- [x] Day " + str(i) + " - [Solutions](./day-" + str(i) + "/readme.md) " + cpp + java + py)
#     else:
#         month_readme.write("\n- [ ] Day " + str(i) + " -")    
# month_readme.close()
# Made month README
